...
| 2.2          | Establish WBS and Schedule                 | <ul><li>Define system capabilities <li>Create a WBS and projec timline <li>Evaluate benefits </ul>                                    | 3 days                | Sipa & Peter             |
| 2.3          | Define Project Requirements                | <ul><li>Gather and document project requirements <li>Estimate durations <li>Create a project schedule                                 | 3  days               | Sipa                     |
| 2.4          | Define System Architecture                 | <ul><li>Design the software architecture </ul>                                                                                        | 2 days                | All                      |
| 2.5          | Design UI Wireframes and Mockups           | <ul><li>Create visual representations of user interface</ul>                                                                          | 3 days                | Peter                    |
| 3            | Execution                                  |                                                                                                                                       |
| 3.1          | Implement Food Search Feature              | <ul><li>Develop the functionality that allows users to search for food items in the system</ul>                                       | 7 days                | All                      |
...
| 4.1.1        | Weekly Team Check-In                       | <ul><li>Regular meetings to discuss progress</ul>                                                                                     | 0.5 days/week ongoing | All                      |
...
## 4. Gantt Chart
![Gantt Chart](./Gantt%20Chart/GanttChart.png)